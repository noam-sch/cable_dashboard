...
git clone [https://github.com/yourusername/cable-dashboard.git](https://github.com/yourusername/cable-dashboard.git)
cd cable-dashboard
...
The build command npm run build will be detected automatically.

📊 Data Credits

Data provided by TeleGeography.
